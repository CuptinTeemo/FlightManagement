...
namespace FlightManagement.Controllers
{
    ...
    public class AirportsController : Controller
    {
        ...
        public AirportsController(FlightManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,GPS")] Airport airport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,GPS")] Airport airport)
        {
            if (id != airport.ID)
            {
                return NotFound();
